# 🧠 Logic Trainer
# Ридми написан ИИшкой. Код функционален, но UI сырое. Я поправлю подпись числа входящих связей в блок и автовыравнивание добавления блоков как будет время. Вкладка MC/DC резервная, позже допилю функциональность, которая позволит сохранять описание к загружаемой схеме
